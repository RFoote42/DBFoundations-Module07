...
-- 2017-01-01,RFoote,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_RFoote')
	 Begin 
	  Alter Database [Assignment07DB_RFoote] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_RFoote;
	 End
	Create Database Assignment07DB_RFoote;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_RFoote;
...
CREATE
	VIEW vProductInventoriesWithPreviouMonthCounts AS
	SELECT TOP 10000000
	ProductName
	,InventoryDate
	,InventoryCount
...
CREATE
	...
	RETURN
		...
		WHERE CountVSPreviousKPI = @KPIValue;
